...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_RETURN_URL: z.string().url().optional(),
    NEXT_PUBLIC_BUILD_ENV: z.enum(BUILD_ENV),
    NEXT_PUBLIC_THEME: z.enum(["light", "dark", "system"]),
    NEXT_PUBLIC_REFERRAL_URL: z.string().url().optional(),
    NEXT_PUBLIC_SHOW_BETA_ANNOUNCEMENT: z.enum(["true", "false"]),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_RETURN_SITE_NAME:
      process.env.NEXT_PUBLIC_RETURN_SITE_NAME ?? "AIR Verifier",
    NEXT_PUBLIC_RETURN_URL:
      process.env.NEXT_PUBLIC_RETURN_URL || undefined,
    ...
    NEXT_PUBLIC_REFERRAL_URL:
      process.env.NEXT_PUBLIC_REFERRAL_URL || undefined,
    NEXT_PUBLIC_SHOW_BETA_ANNOUNCEMENT:
      process.env.NEXT_PUBLIC_SHOW_BETA_ANNOUNCEMENT ?? "false",
